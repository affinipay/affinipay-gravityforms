...
class GFP_ChargeIO_Data {
	...
	public static function update_table () {
		global $wpdb;
		$table_name = self::get_chargeio_table_name();
	 ...
	 * @return string
	 */
	public static function get_chargeio_table_name () {
		global $wpdb;

		return $wpdb->prefix . "rg_chargeio";
	}
	...
	public static function get_transaction_table_name () {
		...
		return $wpdb->prefix . "rg_chargeio_transaction";
	}
	...
	public static function drop_tables () {
		global $wpdb;
		$wpdb->query( "DROP TABLE IF EXISTS " . self::get_chargeio_table_name() );
	}
